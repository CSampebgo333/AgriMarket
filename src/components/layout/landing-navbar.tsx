    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center justify-center gap-6 text-sm absolute left-1/2 transform -translate-x-1/2">
          <Link href="/products" className="transition-colors hover:text-primary cursor-pointer">
            Products
          </Link>
          <Link href="/sellers" className="transition-colors hover:text-primary cursor-pointer">
            Sellers
          </Link>
          <Link href="/about" className="transition-colors hover:text-primary cursor-pointer">
            About
          </Link>
          <Link href="/contact" className="transition-colors hover:text-primary cursor-pointer">
            Contact
          </Link>
        </nav>
